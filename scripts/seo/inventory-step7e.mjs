...
const dir='docs/seo-review/step-7e-evidence';
const before=JSON.parse(readFileSync(dir+'/ai-before.json'));
...
const live=JSON.parse(readFileSync('/private/tmp/kp-step7e-live-before.json')).find(p=>p.url==='https://kpinfo.tech/services/ai-automation-agents/');
