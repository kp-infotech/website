...
const dir='docs/seo-review/step-3-evidence';
const docs=await c.fetch('*[!(_id in path("drafts.**"))]');
writeFileSync('/private/tmp/kp-step3-cms-before.json',JSON.stringify(docs,null,2));
const posts=docs.filter(d=>d._type==='blogPost');
writeFileSync(dir+'/cms-articles-before.json',JSON.stringify(posts,null,2));
...
writeFileSync('/private/tmp/kp-step3-live-before.json',JSON.stringify(pages));
