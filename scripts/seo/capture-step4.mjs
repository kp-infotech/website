...
const dir='docs/seo-review/step-4-evidence';
const docs=await c.fetch('*[!(_id in path("drafts.**"))]');
writeFileSync('/private/tmp/kp-step4-cms-before.json',JSON.stringify(docs,null,2));
const posts=docs.filter(d=>d._type==='blogPost');
writeFileSync('/private/tmp/kp-step4-cms-articles-before.json',JSON.stringify(posts,null,2));
...
writeFileSync('/private/tmp/kp-step4-live-before.json',JSON.stringify(pages));
