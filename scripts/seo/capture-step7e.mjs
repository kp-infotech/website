...
writeFileSync('/private/tmp/kp-step7e-cms-before.json',JSON.stringify(docs,null,2));
const posts=docs.filter(d=>d._type==='blogPost');
writeFileSync('/private/tmp/kp-step7e-cms-articles-before.json',JSON.stringify(posts,null,2));
...
writeFileSync('/private/tmp/kp-step7e-live-before.json',JSON.stringify(pages));
