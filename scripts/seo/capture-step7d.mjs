...
writeFileSync('/private/tmp/kp-step7d-cms-before.json',JSON.stringify(docs,null,2));
const posts=docs.filter(d=>d._type==='blogPost');
writeFileSync('/private/tmp/kp-step7d-cms-articles-before.json',JSON.stringify(posts,null,2));
...
writeFileSync('/private/tmp/kp-step7d-live-before.json',JSON.stringify(pages));
