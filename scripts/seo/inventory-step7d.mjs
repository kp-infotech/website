...
const dir='docs/seo-review/step-7d-evidence';
const before=JSON.parse(readFileSync(dir+'/software-before.json'));
...
const live=JSON.parse(readFileSync('/private/tmp/kp-step7d-live-before.json')).find(p=>p.url==='https://kpinfo.tech/services/custom-software-development/');
