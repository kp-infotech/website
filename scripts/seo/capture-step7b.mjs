...
const dir='docs/seo-review/step-7b-evidence';
const docs=await c.fetch('*[!(_id in path("drafts.**"))]');
writeFileSync('/private/tmp/kp-step7b-cms-before.json',JSON.stringify(docs,null,2));
const posts=docs.filter(d=>d._type==='blogPost');
writeFileSync('/private/tmp/kp-step7b-cms-articles-before.json',JSON.stringify(posts,null,2));
...
writeFileSync('/private/tmp/kp-step7b-live-before.json',JSON.stringify(pages));
